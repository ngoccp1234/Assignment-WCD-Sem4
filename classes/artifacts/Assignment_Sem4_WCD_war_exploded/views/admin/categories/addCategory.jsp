...
<div class="row">
    ...
    <div class="col-md-4 form-group">
        <form action="/admin/category/add" method="post">
            ...
            <input type="text" name="nameCategory" id="nameCategory" width="200px" class="form-control"
            ...
            <textarea class="form-control" rows="5" name="descriptionCategory" id="descriptionCategory"  placeholder="Please enter link description category." ></textarea>
            <br>
