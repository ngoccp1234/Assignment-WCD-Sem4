...
<div class="row">
    ...
    <div class="col-md-4 form-group">
        <form action="/admin/user/add" method="post">
            ...
            <input type="text" name="nameUser" width="200px" class="form-control" required
                   placeholder="Please enter name for user.">
            <br>
            <label  style="font-weight: bold">Email: </label>
            <input type="email" name="emailUser" width="200px" class="form-control" required
                   placeholder="Please enter email for user.">
            <br>
            <label  style="font-weight: bold">Phone: </label>
            <input type="number" name="phoneUser" width="200px" class="form-control" required
                   placeholder="Please enter phone for user.">
            <br>
            <label  style="font-weight: bold">Username: </label>
            <input type="text" name="usernameUser" width="200px" class="form-control" required
                   placeholder="Please enter username for user.">
            <br>
            <label  style="font-weight: bold">Password: </label>
            <input type="password" name="passwordUser" width="200px" class="form-control" required
