...
<div class="row">
    ...
    <div class="col-md-4 form-group">
        <form action="/admin/role/add" method="post">
            ...
            <input type="text" name="nameRole" width="200px" class="form-control" required
                   placeholder="Please enter name role.">
            <br>
            <label  style="font-weight: bold">Description: </label>
            <textarea class="form-control" rows="5" name="descriptionRole"   placeholder="Please enter link description role." required></textarea>
            <br>
