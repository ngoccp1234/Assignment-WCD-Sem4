...
<div class="row">
    ...
    <div class="col-md-4 form-group">
        <form action="/admin/category/add" method="post">
            <label for="nameCategory" style="font-weight: bold">Name: </label>
            <input type="text" name="nameCategory" id="nameCategory" width="200px" class="form-control" required
            ...
            <br>
            <label for="descriptionCategory" style="font-weight: bold">Description: </label>
            <textarea class="form-control" rows="5" name="descriptionCategory" id="descriptionCategory"  placeholder="Please enter link description category." required></textarea>
            <br>
            <label for="statusCategory" style="font-weight: bold">Status: </label>
            <select name="statusCategory" id="statusCategory" class="form-control">
